...
class CrowdinPushCommand extends ContainerAwareCommand
{
    /**
     * {@inheritdoc}
     */
    protected function configure()
    {
        $this
            ...
            ->setDescription('Crowdin Push command')
            ->setHelp(<<<EOF
Pushes translation source to Crowdin.
EOF
            );
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->writeln('Pushing to Crowdin');
        $command = 'java -jar app/Resources/Crowdin/crowdin-cli.jar upload sources';
        exec($command);
    }
}
